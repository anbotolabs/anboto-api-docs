...
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|home 200 response|string|
...
|---|---|---|---|---|
|orderIds|query|array[integer]|false|none|
|clientOrderIds|query|array[string]|false|none|
...
|Name|In|Type|Required|Description|
|---|---|---|---|---|
|startMs|query|integer(int64)|false|none|
|endMs|query|integer(int64)|false|none|
...
|side|[Side_1](#schemaside_1)¦null|false|none|none|
...
<h2 id="tocS_Side_1">Side_1</h2>
<!-- backwards compatibility -->
<a id="schemaside_1"></a>
<a id="schema_Side_1"></a>
<a id="tocSside_1"></a>
<a id="tocsside_1"></a>
